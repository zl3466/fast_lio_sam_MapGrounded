...
// External declaration for log subfolder (defined in laserMapping.cpp)
extern string log_subfolder;

// Get log file path with subfolder support
inline string GetLogFilePath(const string& filename) {
    string log_path = string(ROOT_DIR) + "Log/";
...
struct MeasureGroup     // Lidar data and imu dates for the curent process
{
    ...
    size_t lidar_frame_idx = 0; // absolute frame index in rosbag order
};
